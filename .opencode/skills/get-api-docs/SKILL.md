name: get-api-docs
description: >
Retrieve accurate API documentation before writing code.
Always query `chub` first. If documentation is missing or outdated,
fallback to `context7`. Never rely on training knowledge for API shapes.
